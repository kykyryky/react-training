...
- [Course project workflow](#course-project-workflow)
...
```sh
 npm install
```
once. This will get all required dependencies.

## Course project workflow

Workflow of this course project is similar with [GitHub Flow](https://guides.github.com/introduction/flow/) excluding one thing - deployment.

![GitHub Flow](https://habrastorage.org/files/545/962/0f5/5459620f5d974245a235689bdcde1fbe.gif)

**Please review:** ["Understanding the GitHub Flow"](https://guides.github.com/introduction/flow/)

> Important! You **don’t** have to **fork** course repo.

## Deployment

Your project are already served by BitBucket-pages and avaliable via URL `<repo-name>.bitbucket.org`.

To deploy your project to BitBucket-pages just `git push` branch which you want to deploy, like a
```
git push origin <feature-branch>
```

> Note: deployment process are not synchronized with Git Flow.<br>
> It means that you can deploy any branch, event if branch are not merged to `master` or waiting for PR review.
